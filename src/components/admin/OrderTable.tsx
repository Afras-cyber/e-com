              ...
              {data?.orders.map((order: any) => {
                ...
                return (
                  <tr key={order._id} className="border-b transition-colors hover:bg-muted/50">
                    <td className="p-4 align-middle font-bold text-primary text-xs">{order.orderNumber}</td>
                    ...
                    <td className="p-4 align-middle font-bold text-xs">
                      {formatPrice(order.negotiatedTotal || order.totalAmount)}
                    </td>
                    <td className="p-4 align-middle text-muted-foreground text-xs">
                      {format(new Date(order.createdAt), 'MM dd, yy')}
                    </td>
                    <td className="p-4 align-middle">
                      <div className={cn("inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-bold text-xs", status.color)}>
