      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden bg-zinc-950">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl">
          ...
          <p className="text-zinc-400 text-lg md:text-2xl max-w-2xl mx-auto font-medium">
            Sri Lanka's premier destination for high-end sneakers and designer
            bags. Curated by enthusiasts, for enthusiasts.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-6">
              ...
              <h2 className="text-4xl md:text-5xl font-black tracking-tight leading-tight">
                From a Passion Project to{" "}
                <span className="text-primary">Market Leader</span>
              </h2>
              <p className="text-lg text-muted-foreground leading-relaxed">
                Legacy Sports began in 2022 with a simple mission: to bridge the gap
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                We believe that authentic luxury should be accessible, verified,
                and accompanied by exceptional service. That's why every product
                in our catalog undergoes a rigorous multi-point inspection
                process before it ever reaches our shop.
              </p>
            ...
            <div className="relative group">
              ...
              <div className="relative aspect-square rounded-[3rem] bg-zinc-100 dark:bg-zinc-900 overflow-hidden border border-zinc-200 dark:border-zinc-800 shadow-2xl">
                <div className="absolute inset-0 flex items-center justify-center text-zinc-300 dark:text-zinc-700 font-bold text-xl p-12 text-center italic">
                  "Authenticity is the soul of luxury. We never compromise on
                  that promise."
                </div>
              </div>
              <div className="absolute -bottom-8 -right-8 bg-white dark:bg-zinc-900 p-8 rounded-3xl shadow-xl border border-zinc-100 dark:border-zinc-800 max-w-[240px]">
                <p className="text-sm font-medium italic text-zinc-500 dark:text-zinc-400">
                  "Legacy Sports isn't just a store; it's a culture. We're building
            ...
            {[
              {
                ...
                description:
                  "Our multi-stage verification process ensures that every pair of sneakers and every luxury bag is 100% genuine. No exceptions.",
                color: "text-blue-500",
                bg: "bg-blue-500/10",
              },
              {
                ...
                description:
                  "Experience luxury service via WhatsApp. Our dedicated concierges help you find the right size and style for your needs.",
              ...
              },
              {
                ...
                description:
                  "We treat your purchases with the utmost care. Premium packaging and secure, insured shipping are standard for every order.",
                color: "text-rose-500",
                bg: "bg-rose-500/10",
              },
            ].map((value, i) => (
              <div
                key={i}
                className="bg-white dark:bg-zinc-900 p-10 rounded-[2.5rem] border border-zinc-200 dark:border-zinc-800 transition-all hover:shadow-xl hover:-translate-y-1"
              >
                <div
                  className={`h-16 w-16 rounded-2xl ${value.bg} ${value.color} flex items-center justify-center mb-6`}
                >
                  <value.icon size={32} />
                </div>
      ...
      <section className="py-24 px-4 relative overflow-hidden bg-primary text-white">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl md:text-2xl text-primary-foreground/80 leading-relaxed mb-12">
            We understand the thrill of the hunt and the joy of unboxing
            something special. That's why we're committed to delivering that
            experience to you, perfectly, every single time.
          </p>
