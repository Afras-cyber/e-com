...
export const metadata: Metadata = generateSEOMetadata({
  ...
  ogDescription:
    "Shop authentic premium shoes with fast delivery across Sri Lanka. Quality guaranteed, easy returns.",
  canonicalUrl: siteConfig.url,
  keywords:
    "shoes, authentic sneakers, premium footwear, buy shoes online, Sri Lanka shoes, casual shoes, sports shoes, designer shoes",
...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen overflow-x-hidden">
      <StructuredData
        data={generateBreadcrumbSchema([{ name: "Home", url: siteConfig.url }])}
      />
