        ...
        await resend.emails.send({
          ...
          html: `
            <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #eee; border-radius: 10px;">
              ...
              <p>You can track your order live at: <a href="${process.env.NEXT_PUBLIC_APP_URL || "https://ckrshoes.lk"}/track?order=${order.orderNumber}">${process.env.NEXT_PUBLIC_APP_URL || "https://ckrshoes.lk"}/track</a></p>
