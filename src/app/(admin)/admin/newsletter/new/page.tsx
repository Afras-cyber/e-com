    ...
    <div className="max-w-4xl mx-auto space-y-8">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            {loading ? (
              <RefreshLinear className="h-4 w-4 animate-spin" />
            ) : (
          ...
          <form className="space-y-6 bg-card border rounded-2xl p-8 shadow-sm">
            <div className="space-y-2">
              ...
              <input
                ...
                placeholder="Exciting updates from Legacy Sports!"
            ...
            <div className="p-10 bg-white">
              <div
                ...
                dangerouslySetInnerHTML={{
                  __html:
                    formData.content ||
                    '<p class="text-muted-foreground italic text-center">No content yet...</p>',
                }}
              />
            </div>
          </div>
